...
{{--    </section>--}}
    ...
    >
        ...
        <h1 style="text-align: center; padding-bottom: 10px">قم بأدخال معلومات باب الخشب</h1>
        <form action="{{route('doors.store')}}" class="form" method="post" enctype="multipart/form-data">
            @csrf
            <label style="font-weight: 700;font-size: large">قم بأدخال شرح حول الباب:</label><br><br>
            <input style="width: 90%" type="text" name="title" ><br><br>
            <label style="font-weight: 700;font-size: large">أدرج صورة الباب :</label><br><br>
            <input type="file" name="photo"><br><br>
